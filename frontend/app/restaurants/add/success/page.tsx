      ...
      <main className="flex-1 flex flex-col items-center justify-center px-10">
        ...
        <div className="text-center space-y-8">
          ...
          <Link href="/restaurants">
            <button className="px-10 py-2.5 rounded-full border border-black bg-white text-black font-bold text-sm hover:bg-gray-50 transition-all shadow-sm">
              Ver restaurante
            </button>
          </Link>
        </div>
